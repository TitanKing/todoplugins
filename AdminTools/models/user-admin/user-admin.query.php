...
class PHPDS_readUserQuery extends PHPDS_query
{
	protected $sql = "
			SELECT
				user_id, user_display_name, user_password, user_name, user_email, user_role, date_registered, language, timezone as user_timezone, region
			FROM
				_db_core_users
			WHERE
				user_id = %u
