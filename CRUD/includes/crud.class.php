...
class crud extends PHPDS_dependant
{
    ...
    public $request;
    /**
     * Should forms be protected against possible injection?
     *
     * @var boolean
     */
    public $protect = true;
     ...
     *
     * @param null $orm Set if you would like the system to verify an encryption before accepting global $_POST variables. Use with method send_crypt_key_validation in your form.
     *
     * @return bool|void
     */
     ...
     *
     * @param string $error_message
     * @param string $field This should be the element id name, else it will use the form tag.
     * @author Jason Schoeman
     */
